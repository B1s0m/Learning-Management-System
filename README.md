...
* As a guest, I want to view available courses so that I can explore the platform.
* As a guest, I want to view course details so that I can decide whether a course is suitable for me.
...
* As a student, I want to edit or delete my review so that I can manage my feedback.
...
* As an instructor, I want to edit assignment instructions and deadlines.
* As an instructor, I want to delete assignments that are no longer required.
* As an instructor, I want to upload assignment instructions as PDF files.
* As an instructor, I want to view all student submissions.
* As an instructor, I want to download submitted PDF files.
